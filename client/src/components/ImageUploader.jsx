...
import { loadProductsFromStorage } from '../utils/productHasher.js';
...
export default function ImageMatcher() {
    ...
    async function loadProductData() {
        // Try to load from localStorage first (precomputed)
        const storedProducts = loadProductsFromStorage();
        if (storedProducts && storedProducts.length > 0) {
            console.log('📦 Loaded precomputed products from localStorage:', storedProducts.length);
            setProducts(storedProducts);
            setInitialLoad(false);
        } else {
            console.log('� Computing hashes for the first time - this may take a moment...');
            ...
            console.log('✅ Hash computation complete! Products saved to localStorage.');
        }
    }
